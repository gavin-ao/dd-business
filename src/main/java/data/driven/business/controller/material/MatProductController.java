package data.driven.business.controller.material;
...
import data.driven.business.controller.wechatapi.ScenicSpotApiController;
 ...
 */
@Controller
@RequestMapping(path = "/material/product")
public class MatProductController {
